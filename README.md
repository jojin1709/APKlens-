...
<a href="https://apklens-in.vercel.app/"><img src="https://img.shields.io/badge/🚀_Launch_Live_App-3DDC84?style=for-the-badge&logo=vercel&logoColor=black" alt="Launch Live App"></a>&nbsp;
...
| 3 | 📜 **AndroidManifest** | IDE-style XML viewer with syntax highlighting, line numbers, and copy-to-clipboard — fully decoded from binary AXML format |
...
| 8 | ⚙️ **Native Libraries (.so)** | ELF32/ELF64 architecture inspection, endianness, linked shared objects, and exported JNI entry points |
...
| 11 | 🛡️ **Security & Secrets** | Hardcoded credential scanner (AWS, Google, Firebase, Stripe) and insecure cryptography checks |
| 12 | 🏅 **OWASP Mobile Top 10** | Automated mapping of findings to OWASP MASTG / Mobile Top 10 risk categories |
| 13 | 🔑 **Certificate & Signing** | Extraction of v1 (JAR) and v2/v3 (APK Signing Block) X.509 certs, validity dates, and SHA-256 fingerprints |
| 14 | ⚡ **Technology Stack** | Fingerprinting of frameworks and SDKs (Jetpack, Flutter, React Native, Unity, OkHttp, Firebase) |
| 15 | 📄 **Reports & Exports** | One-click JSON data dumps, OASIS SARIF 2.1.0 DevSecOps exports, and printable executive PDF reports |
...
- **Premium Atomic Black UI:** Designed with a sleek dark Atomic Black aesthetic (`#08080a`), Android green (`#3DDC84`) accents, glassmorphism panels, smooth micro-animations, a fixed sidebar navigator, and a premium APK scan loading experience.
...
3. Switch through the 15 analysis tabs to inspect components, decode manifests, audit permissions, view native libraries, and decompile source classes.
...
<a href="https://github.com/jojin1709/APKlens-/stargazers"><img src="https://img.shields.io/badge/⭐_Star-3DDC84?style=for-the-badge&logo=github&logoColor=black" alt="Star on GitHub"></a>&nbsp;
